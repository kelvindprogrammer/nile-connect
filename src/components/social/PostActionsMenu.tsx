...
const PostActionsMenu: React.FC<PostActionsMenuProps> = ({
    ...
    const itemClass =
        'w-full flex items-center gap-3 px-3.5 py-2.5 text-left text-xs text-gray-700 ' +
        ...
        <>
            <div className="relative" ref={ref}>
                ...
                {open && (
                    <div
                        role="menu"
                        className="absolute right-0 top-full mt-1 z-40 w-60 bg-white border border-gray-100
                                   rounded-2xl shadow-soft-md overflow-hidden py-1
                                    ...
                                    <div className="px-3.5 py-2.5 bg-gray-50">
                                        ...
                                        <div className="flex gap-2">
                                            <button onClick={handleMute} disabled={busy === 'mute'}
                                                className="flex-1 py-1.5 rounded-lg bg-gray-900 text-white text-[11px] font-medium disabled:opacity-50">
                                                {busy === 'mute' ? 'Muting…' : 'Mute'}
                                            </button>
                                            <button onClick={() => setConfirming(null)}
                                                className="flex-1 py-1.5 rounded-lg border border-gray-200 text-[11px] font-medium">
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
