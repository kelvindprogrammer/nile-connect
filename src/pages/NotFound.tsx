...
const NotFound = () => (
    <div className="min-h-screen bg-nile-white flex flex-col items-center justify-center p-6 font-sans">
        <div className="w-full max-w-lg space-y-8">
            {/* 404 Hero */}
            <div className="bg-nile-blue p-10 rounded-2xl text-center space-y-4 shadow-card">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-xl mx-auto shadow-soft-sm">
