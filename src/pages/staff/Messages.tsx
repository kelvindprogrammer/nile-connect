...
const conversations = [
    { id: 1, name: 'Employer: Google Tech', lastMsg: 'The tech fair registration is...', time: '12:45 PM', unread: 2, online: true },
    { id: 2, name: 'Grace Stanley', lastMsg: 'My CV verification is pending...', time: 'Yesterday', unread: 0, online: false },
    { id: 3, name: 'Career Services Dept', lastMsg: 'Team meeting at 3 PM today', time: 'Monday', unread: 0, online: true },
];
...
const StaffMessages = () => {
    ...
    return (
        <div className="flex h-full bg-white overflow-hidden anime-fade-in font-sans pb-20 md:pb-0">
            ...
            `}>
                <div className="p-6 space-y-4 border-b-[2px] border-black bg-white text-left">
                    <div className="flex justify-between items-center">
                        <h2 className="text-2xl font-black text-black uppercase tracking-tighter">Communications .</h2>
                        <button className="p-2 border-2 border-black rounded-lg hover:bg-black hover:text-white transition-all text-nile-blue">
                    ...
                    <div className="relative group">
                        ...
                        <input 
                            type="text" 
                            placeholder="SEARCH SYSTEM CHATS..." 
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                    {conversations.map(c => (
                        ...
                        >
                            ...
                            {c.unread > 0 && (
                                <div className="absolute right-4 top-1/2 -translate-y-1/2 bg-black text-white text-[8px] font-black w-5 h-5 flex items-center justify-center rounded-full border-2 border-white shadow-[2px_2px_0px_0px_#1E499D]">
                                    {c.unread}
                                </div>
                            )}
                        </div>
                ...
                {selected ? (
                    <>
                        ...
                        <div className="flex-1 p-4 md:p-8 overflow-y-auto space-y-6 md:space-y-8 bg-nile-white/10 flex flex-col justify-end">
                            ...
                            <div className="flex gap-4 max-w-[85%] ml-auto flex-row-reverse text-right">
                                <div className="p-4 bg-black text-white border-2 border-black rounded-[20px] rounded-tr-none shadow-[4px_4px_0px_0px_rgba(30,73,157,1)]">
                                    <p className="text-[11px] md:text-xs font-black uppercase leading-relaxed">Checking the verification status now. We will provide an update within the hour.</p>
                        ...
                        <div className="p-4 md:p-8 border-t-[2px] border-black bg-white">
                            <div className="relative group">
                                ...
                                <div className="absolute right-2 md:right-3 top-1/2 -translate-y-1/2 flex items-center space-x-2">
                                    ...
                                    <button className="p-2 md:p-3 bg-black text-white border-2 border-black rounded-xl hover:translate-y-[-2px] transition-all shadow-[2px_2px_0px_0px_#1E499D]">
                                        <Send size={16} />
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center space-y-6 md:space-y-8 p-8">
                         ...
                         <div className="text-center space-y-2 text-left md:text-center">
                            ...
                            <p className="max-w-[280px] md:max-w-xs text-[10px] md:text-xs font-bold text-nile-blue/40 uppercase tracking-widest leading-relaxed">Monitor and manage all internal platform communications and professional inquiries.</p>
                         </div>
                    </div>
                )}
            </div>
