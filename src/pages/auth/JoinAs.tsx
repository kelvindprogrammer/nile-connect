    ...
    const leftPanelContent = (
        <div className="flex flex-col items-center text-center">
            ...
            <div className="space-y-1">
                <h2 className="text-2xl font-semibold text-white leading-none uppercase tracking-[0.2em]">
                    PROFILES .
                </h2>
                <p className="text-[9px] font-semibold text-white/50 uppercase tracking-[0.4em]">WHO ARE YOU?</p>
            </div>
        </div>
    );
        ...
        <AuthLayout leftContent={leftPanelContent}>
            <div className="space-y-10 anime-fade-in text-left">
                ...
                <div className="space-y-2">
                    <h1 className="text-4xl font-semibold text-black uppercase tracking-tight">JOIN AS...</h1>
                    <p className="text-[9px] font-semibold text-nile-blue uppercase tracking-[0.25em]">
                ...
                <div className="space-y-4">
                    ...
                    >
                        ...
                        <div className="text-left">
                            <h3 className="text-sm font-semibold tracking-tight text-black leading-none">STUDENT</h3>
                    ...
                    >
                        ...
                        <div className="text-left">
                            <h3 className="text-sm font-semibold tracking-tight text-black leading-none">STAFF</h3>
                    ...
                    >
                        ...
                        <div className="text-left">
                            <h3 className="text-sm font-semibold tracking-tight text-black leading-none">EMPLOYER</h3>
                ...
                <div className="pt-6 border-t-[2px] border-paper-400/5 text-center">
                    <button 
                        ...
                        className="text-[9px] font-semibold text-nile-blue/40 hover:text-black transition-colors uppercase tracking-[0.2em] border-b-[1px] border-transparent hover:border-paper-400/20 pb-0.5"
                    >
