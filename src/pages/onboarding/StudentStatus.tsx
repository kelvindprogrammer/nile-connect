    ...
    const leftPanelContent = (
        <div className="flex flex-col items-center text-center">
            ...
            <div className="space-y-1">
                ...
                <p className="text-[9px] font-semibold text-white/50 uppercase tracking-[0.4em]">ACADEMIC STANDING</p>
            </div>
        </div>
    );
        ...
        <AuthLayout leftContent={leftPanelContent}>
            <div className="space-y-12 anime-fade-in text-left">
                <div className="space-y-2">
                    <h1 className="text-4xl font-semibold text-black uppercase tracking-tight">STUDENT TYPE</h1>
                ...
                <div className="space-y-4">
                    ...
                    >
                        <h3 className="text-lg font-semibold uppercase tracking-[0.2em] text-black">CURRENT</h3>
                    ...
                    <button 
                        ...
                        className="w-full border-[2px] border-paper-400 rounded-xl py-8 shadow-[4px_4px_0px_0px_#000] flex flex-col items-center justify-center cursor-pointer transition-all hover:bg-nile-blue active:scale-[0.98] bg-black group"
                    >
                        <h3 className="text-lg font-semibold uppercase tracking-[0.2em] text-white">ALUMNI</h3>
