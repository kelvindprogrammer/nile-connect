...
const StudentStatus = () => {
    ...
    const leftPanelContent = (
        <div className="flex flex-col items-center text-center">
            <div className="relative z-10 w-24 h-24 bg-white border border-paper-400 rounded-xl shadow-soft-sm flex items-center justify-center mb-10 transition-transform hover:rotate-2">
            ...
            <div className="space-y-12 anime-fade-in text-left">
                ...
                <div className="space-y-4">
                    ...
                    <button 
                        ...
                        className="w-full border border-paper-400 rounded-xl py-8 shadow-soft-sm hover:-translate-y-0.5 hover:shadow-soft-sm bg-white hover:bg-nile-white/50 flex flex-col items-center justify-center cursor-pointer transition-all group"
                    >
                    ...
                    <button 
                        ...
                        className="w-full border border-paper-400 rounded-xl py-8 shadow-soft-sm flex flex-col items-center justify-center cursor-pointer transition-all hover:bg-nile-blue active:scale-[0.98] bg-ink-900 group"
                    >
