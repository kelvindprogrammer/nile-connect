            ...
            <div className="w-full max-w-5xl flex flex-col md:flex-row bg-white border-3 border-paper-400 shadow-soft-sm rounded-[40px] overflow-hidden min-h-[500px] anime-fade-in relative">
                ...
                <div className="flex-1 flex flex-col justify-center p-12 md:p-16 space-y-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 pt-4">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-nile-green text-nile-white font-semibold py-5 rounded-[16px] border-3 border-paper-400 shadow-soft-sm hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none active:scale-95 transition-all text-sm tracking-tight flex items-center justify-center space-x-3 group mt-4"
                        >
                            <span>SIGN IN</span>
